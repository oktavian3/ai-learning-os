...
export const courseModules:CourseModule[] = [
  module(1,"ai-fundamentals","Dasar AI Tanpa Bikin Pusing","AI, ML, GenAI—bedanya apa, kenapa mendadak ada di mana-mana, dan kapan jawabannya jangan dipercaya.","Pemula","2 jam",["Punya gambaran besar tentang AI","Tahu batas AI dan cara mememeriksa jawabannya"],["ChatGPT","Gemini"],"Peta use case AI pribadi",["M01.L01","M01.L04"]),
  ...
  module(8,"api-webhook","API & Webhook buat Non-Developer","Agar aplikasi bisa berkomunikasi satu sama lain. Cukup teknis untuk membuat sesuatu, tanpa kuliah backend dulu.","Menengah","1.5 jam",["Paham request, response, JSON, dan auth","Bisa membaca alur webhook"],["Postman","n8n","JSON"],"Webhook lead router",["M08.L02"]),
  ...
  module(11,"agent-orchestration","Agent Orchestration","Kalau satu agent memang tidak cukup, baru pakai router, supervisor, dan handoff. Jangan membuat lima agent cuma biar diagramnya keren.","Lanjutan","1 jam",["Memilih pola orchestration","Mengukur biaya, waktu, dan kualitas agent"],["LangGraph","Tracing"],"Multi-agent writing system",["M10.L03"]),
  ...
  module(13,"monetization","Jual Skill AI Tanpa Jual Mimpi","Cari masalah yang layak dibayar, membuat paket yang jelas, dan jangan menjanjikan hal yang belum pernah kamu buktikan.","Menengah","2 jam",["Menyusun offer yang jelas","Memilih jalur karier AI yang cocok"],["Notion","Loom"],"Paket layanan AI pertama",["M12.L01","M12.L02"]),
