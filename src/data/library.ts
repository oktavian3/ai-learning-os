...
export const roadmap:RoadmapLevel[]=[
  [0,"AI Literacy","Baru mulai","Kenalan sama istilah penting, batas AI, dan cara tau kapan jawabannya ngawur",["ChatGPT","Gemini"],"4 lesson","Gak gampang ketipu jawaban yang terdengar yakin","Bikin peta konsep AI"],
